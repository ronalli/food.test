...
function calc() {
  ...
  getStaticInformation('.calculating__choose_big', 'calculating__choose-item_active'); // function returnNumber(number) {
...
function card() {
  class MenuCard {
    constructor(title, description, price, srcImage, alt, parentSelector) {
      this.title = title;
...
function closeModal(modalSelector) {
  ...
  modalWindow.classList.remove('show'); // modalWindow.classList.toggle('show');
...
function openModal(modalSelector, setTimeoutModal) {
  ...
  modalWindow.classList.remove('hide'); // modalWindow.classList.toggle('show');
...
function modal(triggerSelector, modalSelector, setTimeoutModal) {
  ...
  btnsModal.forEach(btn => {
    btn.addEventListener('click', () => {
      openModal(modalSelector, setTimeoutModal); // clearTimeout(setTimeoutModal);
    });
...
function slider(_ref) {
  ...
  function indexCheck(currentIndex) {
    let totalLength = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : slides.length;
...
function tabs() {
  ...
  const tabsParent = document.querySelector('.tabheader__items'); // const btnsModal = document.querySelectorAll('[data-modal]'),
  ...
  function showTabContent() {
    ...
    tabs[index].classList.add('tabheader__item_active'); // tabsContent[index].style.display = 'block';
...
window.addEventListener('DOMContentLoaded', () => {
  const setTimeoutModal = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', setTimeoutModal), 50000000);
  ...
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-modal]', '.modal', setTimeoutModal);
  (0,_modules_card__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"])('form', setTimeoutModal);
